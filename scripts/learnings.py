...
Store defaults to <plugin>/memory/learnings.md (resolved from this file).
...
DEFAULT = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "memory", "learnings.md")
