...
4. **Fingerprint thresholds**: any change to `fingerprint.py` or `match_profile.py` must be re-spiked against the existing inspect reports in `docs/` and the results compared to the spike table in `design/reuse.md`.
