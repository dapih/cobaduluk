...
2. Execute `$PLUGIN_ROOT/skills/excel-to-json/workflows/full-pipeline.md` step by step.
...
4. Prefix every script with `$PLUGIN_ROOT/skills/excel-to-json/scripts/`. Resolve `$PLUGIN_ROOT` via `resolve_plugin_root.py` if not already set.
