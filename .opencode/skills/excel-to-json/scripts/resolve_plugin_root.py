...
Resolution order:
  ...
  5. Walk upward from this script's location (works when invoked as
     python excel-to-json/skills/excel-to-json/scripts/resolve_plugin_root.py)
  6. Fail with a pointer to INSTALL.md

Usage:
    python skills/excel-to-json/scripts/resolve_plugin_root.py
    python path/to/cobaduluk/skills/excel-to-json/scripts/resolve_plugin_root.py
...
MARKER = Path("skills/excel-to-json/workflows") / "full-pipeline.md"
