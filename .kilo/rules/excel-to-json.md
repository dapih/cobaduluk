...
For Excel/xlsx → JSON tasks, **load skill `excel-to-json`** and follow [`workflows/full-pipeline.md`](../../skills/excel-to-json/workflows/full-pipeline.md).

- Skill: [`skills/excel-to-json/SKILL.md`](../../skills/excel-to-json/SKILL.md) (also at `.kilo/skills/excel-to-json/SKILL.md`)
- Plugin root: `python skills/excel-to-json/scripts/resolve_plugin_root.py` (or `EXCEL_TO_JSON_ROOT`)
